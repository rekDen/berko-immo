...
import { computeIncomeStatement } from "@/lib/weg-buchhaltung/ledger";

// GET /api/weg-buchhaltung/reports/income-statement?property_id=...&from=YYYY-MM-DD&to=YYYY-MM-DD
// GuV (Erfolgskonten) für einen Zeitraum (weg-buchhaltung-spec.md B7).
export async function GET(request: NextRequest) {
  ...
  const report = computeIncomeStatement(
