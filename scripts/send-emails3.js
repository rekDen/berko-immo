 ...
 *      - Anzeigename = simulierter Absender, z.B. '"Anja Becker (via Müller)" <smtp@example.com>'
 ...
 *   SMTP_FROM       Echte Absenderadresse, z.B. "noreply@Müller-estate.de"
...
const EMAILS = [
  // ===== objektbezogen (5) =====
  {
    ...
    sender: { name: 'Objektaufnahme', email: 'aufnahme@nesthub.de' },
...
Hausverwaltung Müller`,
  ...
  {
    category: 'objektbezogen',
    sender: { name: 'D. Müller (Hausverwaltung)', email: 'verwaltung@nesthub.de' },
...
Sandra Krüger`,
  ...
  // ===== Finanzen & Abrechnung (5) =====
  {
    ...
    sender: { name: 'Buchhaltung Hausverwaltung', email: 'buchhaltung@nesthub.de' },
...
Müller`,
  ...
  {
    category: 'Termine & Organisation',
    sender: { name: 'Sekretariat Hausverwaltung', email: 'sekretariat@nesthub.de' },
...
Berko AI Customer Success`,
  ...
  {
    category: 'Intern',
    sender: { name: 'IT-Administration', email: 'it@nesthub.de' },
...
Vor- und Nachname
Position
Müller Estate / Hausverwaltung
Beispielstraße 12, 04109 Leipzig
Tel: +49 341 1234567
E-Mail: name@Müller-estate.de
Web: www.Müller-estate.de

Geschäftsführer: Denis Müller
...
IT-Administration`,
  ...
  {
    category: 'Newsletter',
    sender: { name: 'Hausverwaltung Newsletter', email: 'newsletter@nesthub.de' },
    subject: 'Newsletter Mai 2026 - Hausverwaltung Müller',
    body:
 ...
 * reply-to : FROM = "Simulierter Name (via Müller) <SMTP_FROM>"
...
function buildHeaders(mail) {
  ...
  // From = exakt die echte SMTP-Adresse, kein fremder Anzeigename
  // (manche Server prüfen auch den Display-Namen auf erlaubte Domains)
  return {
    from: CONFIG.from,
    replyTo: formatAddress(simulated),
  };
